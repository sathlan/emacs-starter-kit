...
(defun pretty-lambdas ()
  (if (not (string= major-mode "scheme-mode"))
...
** Some variables
Add the path to the info file here and if the =dir= file is not
present, you must start in the directory.
#+begin_src sh
  install-info --dir-file dir <file>.info
#+end_src
#+begin_src emacs-lisp
  (setq Info-additional-directory-list '("~/.emacs.d/src/org/doc"
                                         "~/.emacs.d/src/magit"
                                         "/home/chem/.emacs.d/src/jabber"
                                         "/usr/home/chem/.emacs.d/src/gnus/texi"
                                         "~/.emacs.d/src/geiser/doc"
                                         "~/.emacs.d/src/slime/doc"))
